...
public class CarefulConfigurationTest {
    ...
    public void testConstructorExDefaultPropsNull() {
        new CarefulConfiguration(null);
    }

    @Test
    public void testConstructorDefaultPropsPos() {
        CarefulConfiguration configuration = new CarefulConfiguration(new Properties() {{
            put(KEY_1, VALUE_1);
        }});
    ...
    @Test
    public void testAddWorkerPos() {
        CarefulConfiguration configuration = new CarefulConfiguration(new Properties());

        boolean result1 = configuration.addWorker(worker1);
        boolean result2 = configuration.addWorker(worker1);

        assertTrue(result1 || result2);
    }

    @Test
    public void testAddWorkerNeg() {
        CarefulConfiguration configuration = new CarefulConfiguration(new Properties());
    ...
    @Test
    public void testRemoveWorkerPos() {
        CarefulConfiguration configuration = new CarefulConfiguration(new Properties());

        assert configuration.addWorker(worker1);

        boolean result1 = configuration.removeWorker(worker1);
        boolean result2 = configuration.removeWorker(worker1);

        assertTrue(result1 || result2);
    }

    @Test
    public void testRemoveWorkerNeg() {
        CarefulConfiguration configuration = new CarefulConfiguration(new Properties());
    ...
    @Test
    public void testRequestResourcesPos() {
        CarefulConfiguration configuration = new CarefulConfiguration(new Properties());

        assert configuration.addWorker(worker1);

        configuration.requestResources();

        verify(worker1, times(1)).start();
    }

    @Test
    public void testRequestResourcesNeg() {
        CarefulConfiguration configuration = new CarefulConfiguration(new Properties());

        assert configuration.addWorker(worker1);
        assert configuration.addWorker(worker2);
        assert configuration.removeWorker(worker2);

        configuration.requestResources();

        verify(worker2, never()).start();
    }

    @Test
    public void testReleaseResourcesPos() {
        CarefulConfiguration configuration = new CarefulConfiguration(new Properties());
        ...
        verify(worker1, times(1)).stop();
    }

    @Test
    public void testReleaseResourcesNeg() {
        CarefulConfiguration configuration = new CarefulConfiguration(new Properties());
